  ...
  <div class="page">
    <header class="header">
      ...
      <img
        ...
        alt="Картина Решетникова - Опять двойка. 1952 г."
      />
    ...
    <main class="content">
      ...
      <section class="techniques">
        <h2 class="section-title techniques__section-title">
          Техники обучения
        </h2>
        ...
        <ul class="cards">
          <li class="cards__item">
            <img
              class="cards__image"
              src="../assets/cards/cards-attention.png"
              alt="Книга и руки"
            />
          ...
          <li class="cards__item">
            <img
              class="cards__image"
              src="../assets/cards/cards-recall.png"
              alt="Картинка сатуи"
            />
          ...
          <li class="cards__item">
            <img
              class="cards__image"
              src="../assets/cards/cards-interliving.png"
              alt="Много людей"
            />
          ...
          <li class="cards__item">
            <img
              class="cards__image"
              src="../assets/cards/cards-question.png"
              alt="Пустой хол"
            />
          ...
          <li class="cards__item">
            <img
              class="cards__image"
              src="../assets/cards/cards-competence.png"
              alt="Рука книги"
            />
      ...
      <section class="video">
        <h2 class="section-title video__section-title">Видео нa TED</h2>
      ...
      <section class="feynman">
        ...
        <img
          class="feynman__main-illustration"
          src="../assets/feynman.png"
          alt="Ри́чард Фи́ллипс Фе́йнман"
        />
      </section>
      ...
      <section class="khan">
        <div class="khan__container">
          ...
          <!-- Специально для цитат, где много текста, можно использовать <blockquote> -->
          ...
          <!-- Будет лучше использовать тег заголовка h3 для автора цитаты -->
          <h3 class="khan__quote-author">Джордж Лукас</h3>
          <p class="khan__quote-author-subline">Кинорежиссер, продюсер</p>
          <div class="khan__book-container">
            <img
              class="khan__book-pic"
              src="../assets/khan-book.jpg"
              alt="Обложка книги 'Весь мир — школа'"
            />
      ...
      <section class="kaufman">
        <h2
          class="section-title kaufman__section-title section-title_theme_dark"
        >
          Принципы обучения
        </h2>
      ...
      <section class="resources">
        <h2 class="section-title resources__section-title">Полезные ресурсы</h2>
        ...
        <ul class="resources__logo-zone">
          <li>
            <a href="#" class="resources__link">
              <img
                ...
                src="../assets/logo_resources/resources-arzamas.svg"
                alt="Арзамас"
              />
            </a>
          </li>
          ...
          <li>
            <a href="#" class="resources__link">
              <img
                class="resources__logo"
                src="../assets/logo_resources/resources-n1.svg"
                alt="Н+1"
              />
            </a>
          </li>
          ...
          <li>
            <a href="#" class="resources__link">
              <img
                class="resources__logo"
                src="../assets/logo_resources/resources-strelka.svg"
                alt="Стрелка"
              />
            </a>
          </li>
          ...
          <li>
            <a href="#" class="resources__link">
              <img
                class="resources__logo"
                src="../assets/logo_resources/resources-polka.svg"
                alt="Полка"
              />
            </a>
          </li>
    ...
    <footer class="footer">
      <div class="footer__columns">
        ...
        <div class="footer__column footer__column_content_copyright">
          ...
          <p class="footer__author">&copy; Павел Черданцев</p>
        </div>
        ...
        <nav class="footer__column footer__column_content_social">
          ...
          <ul class="footer__column-links">
            <li>
              <a href="https://www.facebook.com/" class="footer__column-link">
                <img
                  class="footer__social-icon"
                  src="../assets/logo_social/facebook_color_white.svg"
                  alt="Фэйсбук"
                />
                Facebook
              </a>
            ...
            <li>
              <a href="https://vk.com/" class="footer__column-link">
                <img
                  class="footer__social-icon"
                  src="../assets/logo_social/vk_color_white.svg"
                  alt="ВК"
                />
                Вкотнатке
              </a>
            ...
            <li>
              <a href="https://www.instagram.com" class="footer__column-link">
                <img
                  class="footer__social-icon"
                  src="../assets/logo_social/instagram_color_white.svg"
                  alt="Инстаграм"
                />
                Instagram
              </a>
